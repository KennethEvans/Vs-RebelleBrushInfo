...
namespace RebelleBrushInfo {
    class RebelleBrushParam : IComparer {
        ...
        public RebelleBrushParam(string name, string typeName, object value) {
            err = false;
        ...
        /// <summary>
        /// Returns an information string for the value for this RebelleBrushParam.
        /// </summary>
        /// <param name="tab">Prefix for each line, typically "  " or similar.</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns if the given RebelleBrushParam is equal to this one.
        /// </summary>
        /// <param name="param"></param>
        /// <returns></returns>
        public bool equals(RebelleBrushParam param) {
        ...
        public int Compare(RebelleBrushParam x, RebelleBrushParam y) {
            return ((RebelleBrushParam)x).name.CompareTo(((RebelleBrushParam)y).name);
        }
